...
class AuthResourceTest {
    ...
    void logout_rateLimited_returns429() {
        ...
        var res = new AuthResource(stub, AuthRateLimiter.testingDenyLogout(), I18nTestFixtures.messagesEn());
    ...
    void logout_missingRefresh_returns400() {
        var stub = new StubAuthService();
        var res = new AuthResource(stub, AuthRateLimiter.noop(), I18nTestFixtures.messagesEn());

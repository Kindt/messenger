...
/** Read/write extended legal-hold flags (V025) on org/chat retention policy rows. */
public class LegalHoldRepository {
    private static final Logger log = LoggerFactory.getLogger(LegalHoldRepository.class);

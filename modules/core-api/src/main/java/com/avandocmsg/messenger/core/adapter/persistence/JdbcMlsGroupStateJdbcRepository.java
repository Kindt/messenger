...
public final class JdbcMlsGroupStateJdbcRepository {
    private static final Logger log = LoggerFactory.getLogger(JdbcMlsGroupStateJdbcRepository.class);
    private final DataSource dataSource;
    private final Clock clock;

    public JdbcMlsGroupStateJdbcRepository(DataSource dataSource, Clock clock) {

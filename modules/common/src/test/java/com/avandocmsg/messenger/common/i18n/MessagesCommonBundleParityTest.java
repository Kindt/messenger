...
class MessagesCommonBundleParityTest {

    private static final String BASE = "com/avandocmsg/messenger/i18n/messages_common";
    ...
    private static TreeSet<String> keys(String resourcePath) throws Exception {
        ClassLoader cl = MessagesCommonBundleParityTest.class.getClassLoader();

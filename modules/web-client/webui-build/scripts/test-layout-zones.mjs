...
const clientMarkers = [
  ...
  { file: "app.js", src: appJs, needle: "messenger-nav-rail" },
  { file: "app.js", src: appJs, needle: "sidebar-tab--icon-only" },
  { file: "styles.css", src: styles, needle: ".sidebar-content" },
  { file: "styles.css", src: styles, needle: ".messenger-nav-rail" },
  { file: "styles.css", src: styles, needle: ".visually-hidden" },

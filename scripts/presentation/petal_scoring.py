...
KORUS_GAP_TO_5: dict[str, str] = {
    ...
    "vks": "Нужно подтвердить масштаб конференций, запись и работу в сложных сетях заказчика.",
...
KORUS_USER_GAP: dict[str, str] = {
    "profile": "Для максимальной зрелости нужны нативные мобильные клиенты и синхронизация настроек между устройствами.",
    "calls": "Для максимальной зрелости нужны подтверждённый масштаб конференций, студийный интерфейс и настройка сложных сетей.",

...
.version-note { margin: 0 0 16px; color: var(--muted); max-width: 720px; }
.exec-grid {
...
.exec-card-ok { border-left: 5px solid #22c55e; }
.exec-card-warn { border-left: 5px solid #f59e0b; }
.exec-kicker {
  margin: 0 0 6px; font-size: 11px; font-weight: 700; text-transform: uppercase;
  letter-spacing: .06em; color: #64748b;
}
.exec-card h2 { margin: 0 0 8px; font-size: 16px; color: var(--brand); }
...
.fit-card-korus { border-left: 5px solid #22c55e; }
.fit-card-peer { border-left: 5px solid #f59e0b; }
.evidence-appendix {
...
.audience-route {
  margin: 0 0 20px; background: #f8fafc; border: 1px solid var(--border);
  border-radius: 12px; padding: 14px 16px;
}
.audience-route-title { margin: 0 0 10px; font-weight: 700; color: var(--brand); }
.audience-route-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; }
.audience-route a {
  display: block; text-decoration: none; color: inherit; background: #fff; border: 1px solid #dbeafe;
  border-radius: 10px; padding: 12px; min-height: 88px;
}
.audience-route a:hover { border-color: #6366f1; background: #eef2ff; }
.audience-route strong { display: block; font-size: 13px; color: #4338ca; margin-bottom: 5px; }

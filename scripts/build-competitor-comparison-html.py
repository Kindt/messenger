...
<div class="toc small nav">
  <a href="#summary">Сценарии</a> · <a href="#positioning">Позиция Korus</a> · <a href="#decision">Выбор</a> ·
  <a href="#s0">Карта рынка</a> · <a href="#s3">Экономика</a> · <a href="#s5">Функции</a> ·
  <a href="#s7">Плюсы/минусы</a> · <a href="#s8">Источники</a>
</div>
...
<div class="toc small nav technical-only">
  <a href="#s1">Профили</a> · <a href="#s2">Infra Korus</a> · <a href="#s2nt">НТ</a> ·
...
<div class="warn">
  <ul class="comment">
    <li>Цифры infra — ориентиры; формальное нагрузочное тестирование до prod sign-off рекомендуется.</li>
    ...
    <li>Mattermost/Rocket.Chat: «одновременные» ≠ рег. пользов.</li>
    <li>Compass/Loop акции и reseller-цены — сверять с офертой на дату КП.</li>
    <li>МТС Линк Чаты — преемник линейки Dialog; брендинг уточнять у МТС.</li>
...
def main() -> None:
    ...
    build_full = not args.brief_only
    build_brief = not args.full_only

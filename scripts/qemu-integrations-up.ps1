...
if ($Help) {
    Write-Host @"
Usage: .\scripts\qemu-integrations-up.ps1 [-SshWaitSec 600]

Starts QEMU guest korus-integrations (192.168.76.30) with host forwards:
  18190 gateway, 18088 echo-php, 18091 connector, 18093 exchange, 18094 storage,
  18095 ocr, 18096 ai, 12223 SSH.

Requires server/web already up (repo HTTP :18890 for cloud-init).

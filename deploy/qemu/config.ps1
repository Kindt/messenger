...
# integrations solo: 8192; with server+web up use IntegrationsMemoryMbDev (WHPX host RAM budget)
$script:KorusQemuIntegrationsMemoryMb = 8192
$script:KorusQemuIntegrationsMemoryMbDev = 4096
$script:KorusQemuIntegrationsMemoryMbMin = 3584
$script:KorusQemuIntegrationsMemoryMbHeavy = 12288
$script:KorusQemuIntegrationsSmp = 2
# 3-VM on 16-20 GB host: lower server/web so integrations fits under WHPX (not TCG)
$script:KorusQemuThreeVmServerMemoryMb = 8192
$script:KorusQemuThreeVmWebMemoryMb = 2560

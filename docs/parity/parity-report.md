...
**Date**: 2026-05-24  
**Spec**: archived [`specs/archive/002-web-client-server-parity/spec.md`](../../specs/archive/002-web-client-server-parity/spec.md)  
**Plan**: archived [`specs/archive/002-web-client-server-parity/plan.md`](../../specs/archive/002-web-client-server-parity/plan.md)

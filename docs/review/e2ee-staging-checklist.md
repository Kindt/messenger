...
**Do not** set prod `MLS_STATUS=active` until all 8 rows signed in `ops-signoff-log.md` **Signatures** table.

**Quick smoke (after deploy):** `.\scripts\smoke-e2ee-staging.ps1 -BaseUrl https://<domain> -AdminToken <token>`

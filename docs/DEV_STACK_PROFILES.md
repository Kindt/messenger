...
Связанные документы: [`deploy/qemu/README.md`](../deploy/qemu/README.md), [`deploy/qemu/RESOURCES.md`](../deploy/qemu/RESOURCES.md), [`docs/index.html`](index.html) (product deck, sizing narrative), [`docs/plans/2026-06-15-infra-optimization-design.md`](plans/2026-06-15-infra-optimization-design.md).

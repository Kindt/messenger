...
### 10.1 Radar @10k — честность оценок (spec 014)

Лепестковая диаграмма — **субъективная модель для переговоров**, не рейтинг вендора.

| Правило | Применение |
|---------|------------|
| **Не завышать «Реестр / ФСТЭК»** | У Korus **3/5** до сертификата и реестра ПО |
| **E2EE / ИБ** | MLS в коде ≠ prod sign-off |
| **Экономика** | Только якоря S-10k+ (§2–3) |

ФСТЭК и реестр — организационный трек; в FAQ не обещать сертификат «уже есть».

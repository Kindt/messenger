...
| Высокий | **Презентация продукта (spec 018):** self-contained [`docs/index.html`](index.html) на GitHub Pages — Block 0 «рабочий прототип», 4 persona-вкладки; rebuild [`scripts/presentation/README.md`](../scripts/presentation/README.md). |
